...
ThemeData get getdarktheme {
  return ThemeData(
      ...
      tabBarTheme: TabBarThemeData(
          ...
          indicatorColor: AppColors.darkModePrimaryColor,
          labelStyle: TextStyle(
              fontWeight: FontWeight.w500,
              fontSize: 20,
              color: AppColors.darkModePrimaryColor)),
      iconTheme: IconThemeData(color: AppColors.darkModePrimaryColor),
      floatingActionButtonTheme: const FloatingActionButtonThemeData(
          backgroundColor: AppColors.darkModePrimaryColor,
          shape: CircleBorder(),
          iconSize: 40),
      popupMenuTheme:
          PopupMenuThemeData(color: Colors.black, iconColor: Colors.grey),
